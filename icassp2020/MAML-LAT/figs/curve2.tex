\begin{figure}[H]
  ...
  \begin{axis}[
    ...
    xlabel = {Number of pretraining steps ($\times 1000$)},
        ...
        %xmax=130,
        grid=both,
        legend style={at={(0.02,.73)},anchor=south west},
        %legend pos=inner north west,
        ylabel={CER (\si{\percent}})]
  \addplot+[smooth]table{testing/mutli3-swahili};
  \addplot+[smooth]table{testing/meta3-swahili};
   \addplot[style=ultra thick,dashed,] coordinates {(0,43.07) (100,43.07)};
  ...
  \caption{The learning curves of CER on Swahili's LLP}
  \label{fig:curve2}
\end{figure}
